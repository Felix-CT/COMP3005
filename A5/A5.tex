...
{\centering \includegraphics[scale=0.3]{5a.png}}

\subproblem{b} $n = 6$.\indent \indent (4 points)\\
{\centering \includegraphics[scale=0.4]{5b.png}}
\subproblem{c} $n = 8$.\indent \indent (4 points)\\
{\centering \includegraphics[scale=0.5]{5c.png}}
...
{\centering \includegraphics[scale=0.5]{6a.png}}

\subproblem{b} Delete 19 (after the previous deletion in (a)).\indent \indent (4 points)\\
{\centering \includegraphics[scale=0.5]{6b.png}}
...
{\centering \includegraphics[scale=0.15]{7.png}}
